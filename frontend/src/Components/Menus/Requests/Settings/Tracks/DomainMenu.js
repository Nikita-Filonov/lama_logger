...
const DomainMenu = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <MenuItem onClick={onEdit} disabled={!isAllowed([PROJECT_SETTINGS.update])}>
          <ListItemIcon>
            <CreateOutlined fontSize="small"/>
          </ListItemIcon>
          Edit
        </MenuItem>
        <MenuItem sx={{color: 'red'}} onClick={onDelete} disabled={!isAllowed([PROJECT_SETTINGS.delete])}>
          <ListItemIcon>
