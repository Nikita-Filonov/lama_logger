...
urlpatterns = [
    path('admin/' if settings.DEBUG else 'other-admin/', admin.site.urls),
    ...
    path('projects/<int:projects_id>/custom-requests/', TemplateView.as_view(template_name='index.html'), name='index'),
    ...
    path('projects/<int:projects_id>/settings/filters/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/realtime/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/activities/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/patterns/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/domains/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/notifications/', TemplateView.as_view(template_name='index.html'),
         name='index'),
    path('projects/<int:projects_id>/settings/tasks/', TemplateView.as_view(template_name='index.html'),
         name='index'),
]
